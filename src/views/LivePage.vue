  ...
  <div class="main-content" :class="appStore.sidebarCollapsed ? 'collapsed' : 'expanded'">
    ...
    <section class="landing-hero">
      <div class="landing-hero-inner">
        <div>
          <div class="landing-hero-kicker"><i class="bi-broadcast-pin"></i> Live now on KFLIX</div>
          <h1 class="landing-hero-title">Catch the biggest moments in real time.</h1>
          <p class="landing-hero-subtitle">
            Sports, concerts, comedy, and culture — join live streams, set reminders, and never miss the
            moment.
          </p>

          <div class="landing-hero-actions">
            <button type="button" class="btn btn-danger btn-lg">
              <i class="bi-play-btn-fill me-1" /> Watch live
            </button>
            <button type="button" class="btn btn-outline-light btn-lg">
              <i class="bi-calendar-event me-1" /> Upcoming schedule
            </button>
          </div>
        </div>
        ...
        <div class="landing-hero-stats">
          <div class="landing-hero-stat">
            <div class="landing-hero-stat-value">45K</div>
            <div class="landing-hero-stat-label">viewers watching right now</div>
          </div>
          <div class="landing-hero-stat">
            <div class="landing-hero-stat-value">120+</div>
            <div class="landing-hero-stat-label">live shows streaming today</div>
          </div>
          <div class="landing-hero-stat">
            <div class="landing-hero-stat-value">30</div>
            <div class="landing-hero-stat-label">countries tuned in worldwide</div>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="content-section">
      <SectionHeader title="Live Events & Streams" :show-view-all="false" />
      ...
      <div class="stats-grid">
        <div class="stat-card red">
          ...
          <div class="stat-label">Live shows today</div>
        </div>
        <div class="stat-card blue">
          <div class="stat-value">45K</div>
          <div class="stat-label">Viewers right now</div>
        </div>
        <div class="stat-card green">
          <div class="stat-value">30</div>
          <div class="stat-label">Countries tuned in</div>
        </div>
      </div>
    </div>
  </div>
...
const liveEvents = [
  {
    id: 1,
    title: 'Global Afrobeats Festival',
    badge: 'LIVE',
    meta: '82K watching • Music',
  ...
  },
  {
    ...
    badge: 'STAND-UP',
    meta: '21K watching • Entertainment',
    imageUrl: 'https://images.unsplash.com/photo-1585699324551-f6c309eedeca?w=800'
  },
  {
    id: 4,
    title: 'Storytelling from the Village',
    badge: 'CULTURE',
    meta: '9K watching • Culture',
